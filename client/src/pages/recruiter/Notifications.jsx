                ...
                <CardHeader>
                  ...
                  <CardContent className="space-y-6">
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                          <Label htmlFor="email-new-applications" className="text-sm">
                            New Applications
                          </Label>
                          <Switch
                            id="email-new-applications"
                            checked={notificationSettings.email_new_applications}
                            onCheckedChange={() => handleSettingChange("email_new_applications")}
                          />
                        </div>
                        <div className="flex items-center justify-between">
                          <Label htmlFor="email-assessment-completed" className="text-sm">
                            Assessment Completed
                          </Label>
                          <Switch
                            id="email-assessment-completed"
                            checked={notificationSettings.email_assessment_completed}
                            onCheckedChange={() => handleSettingChange("email_assessment_completed")}
                          />
                        </div>
                        <div className="flex items-center justify-between">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                  <div className="flex items-center justify-between">
                          <Label htmlFor="push-new-applications" className="text-sm">
                            New Applications
                    </Label>
                    <Switch
                            id="push-new-applications"
                            checked={notificationSettings.push_new_applications}
                            onCheckedChange={() => handleSettingChange("push_new_applications")}
                    />
                  </div>
                  <div className="flex items-center justify-between">
                          <Label htmlFor="push-assessment-completed" className="text-sm">
                            Assessment Completed
                    </Label>
                    <Switch
                            id="push-assessment-completed"
                            checked={notificationSettings.push_assessment_completed}
                            onCheckedChange={() => handleSettingChange("push_assessment_completed")}
                    />
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                            ...
                            onCheckedChange={() => handleSettingChange("weekly_reports")}
                    />
                        </div>
                      </div>
                  </div>
