...
export default function CreateAssessment() {
  ...
  const handleImportCodeWarsQuestion = (questionData) => {
    ...
    toast({
      ...
      description: "CodeWars challenge has been added to your assessment",
    })
  }
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <Card className="mb-6 bg-green-50 dark:bg-green-900 border-green-200 dark:border-green-700">
              <CardContent className="py-4 flex items-center gap-4">
                ...
                <div>
                  <p className="font-medium text-green-900 dark:text-green-100">You are creating a <span className="font-bold">Private Assessment</span>.</p>
                  <p className="text-green-800 dark:text-green-200 text-sm">Private assessments can only be taken by users you invite. Use these for real hiring, screening, or evaluation processes. Candidates will receive an invitation to participate.</p>
                </div>
              </CardContent>
            </Card>
